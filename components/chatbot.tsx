  ...
  return (
    <div className="rounded-2xl border-zinc-100 p-3 shadow-inner shadow-orange-600/20 md:border md:p-5 lg:border lg:p-6">
      ...
      <div className="clear-both mt-6 flex">
        ...
        <button
          type="submit"
          className="ml-4 inline-flex flex-none items-center justify-center gap-2 rounded-md bg-zinc-600 px-3 py-2 font-semibold text-sm text-zinc-100 outline-offset-2 transition hover:bg-zinc-400 hover:ring-4 hover:ring-purple-500/10 active:bg-zinc-800 active:text-zinc-100/70 active:transition-none"
          onClick={() => {
            sendMessage(input)
            setInput('')
          }}
